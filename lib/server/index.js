...
module.exports = function(app) {
  ...
  const exist = fs.existsSync(path.join(process.cwd(), './public/favicon.ico'));
  // copy out favicon.ico to inner
  if(exist){
    fs.copyFileSync(path.join(process.cwd(), './public/favicon.ico'),path.join(__dirname, '../../public/favicon.ico'));
  }
